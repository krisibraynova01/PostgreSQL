...
id SERIAL PRIMARY KEY,
	...
	CONSTRAINT addresses_check_street_number CHECK (street_number > 0),
	CONSTRAINT addresses_check_zip_code CHECK (zip_code > 0)
);
...
id SERIAL PRIMARY KEY,
	...
	CONSTRAINT players_ranges_check_min_players CHECK (min_players > 0),
	CONSTRAINT players_ranges_check_max_players CHECK (max_players > 0)
);
...
id SERIAL PRIMARY KEY,
	...
	CONSTRAINT board_games_check_release_year CHECK (release_year > 0),
